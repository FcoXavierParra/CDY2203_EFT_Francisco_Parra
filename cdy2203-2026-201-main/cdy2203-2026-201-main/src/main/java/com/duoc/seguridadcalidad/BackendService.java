...
public class BackendService {
    ...
    public Map<String, Object> createPatient(String jwtToken, Map<String, Object> patient) {
        ...
        log.debug("-> BackendService.createPatient Authorization=Bearer {} patient={}", jwtToken, patient);
        try {
    ...
    public Map<String, Object> getPatientById(String jwtToken, Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(jwtToken);
        HttpEntity<Void> entity = new HttpEntity<>(headers);
        ...
        try {
            ...
            log.debug("<- BackendService.getPatientById status={} body={}", response.getStatusCode(), response.getBody());
            return response.getBody();
        } catch (HttpStatusCodeException ex) {
            log.error("Backend getPatientById failed status={} body={}", ex.getStatusCode(), ex.getResponseBodyAsString());
    ...
    public Map<String, Object> updatePatient(String jwtToken, Long id, Map<String, Object> patient) {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(jwtToken);
        HttpEntity<Map<String, Object>> entity = new HttpEntity<>(patient, headers);
    ...
    public void deletePatient(String jwtToken, Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(jwtToken);
        HttpEntity<Void> entity = new HttpEntity<>(headers);
